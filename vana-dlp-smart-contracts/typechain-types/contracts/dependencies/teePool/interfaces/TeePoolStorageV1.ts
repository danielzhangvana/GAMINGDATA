...
export interface TeePoolStorageV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "activeTeeList"
      | "activeTeeListAt"
...
export interface TeePoolStorageV1 extends BaseContract {
  connect(runner?: ContractRunner | null): TeePoolStorageV1;
  waitForDeployment(): Promise<this>;

  interface: TeePoolStorageV1Interface;
