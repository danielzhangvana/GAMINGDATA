...
export interface IDataLiquidityPoolsRootInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRewardForDlps"
      | "claimReward"
...
export interface IDataLiquidityPoolsRoot extends BaseContract {
  connect(runner?: ContractRunner | null): IDataLiquidityPoolsRoot;
  waitForDeployment(): Promise<this>;

  interface: IDataLiquidityPoolsRootInterface;
