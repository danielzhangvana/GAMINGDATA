...
export interface DataLiquidityPoolImplementationV2MockInterface
  extends Interface {
  getFunction(
    nameOrSignature:
...
export interface DataLiquidityPoolImplementationV2Mock extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): DataLiquidityPoolImplementationV2Mock;
  waitForDeployment(): Promise<this>;

  interface: DataLiquidityPoolImplementationV2MockInterface;
