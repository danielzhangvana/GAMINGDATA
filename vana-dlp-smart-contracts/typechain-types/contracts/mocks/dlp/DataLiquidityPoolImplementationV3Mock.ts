...
export interface DataLiquidityPoolImplementationV3MockInterface
  extends Interface {
  getFunction(
    nameOrSignature:
...
export interface DataLiquidityPoolImplementationV3Mock extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): DataLiquidityPoolImplementationV3Mock;
  waitForDeployment(): Promise<this>;

  interface: DataLiquidityPoolImplementationV3MockInterface;
