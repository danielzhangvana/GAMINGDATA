...
import type {
  ...
  DataLiquidityPoolsRootStorageV1Interface,
} from "../../../../../contracts/dependencies/root/interfaces/DataLiquidityPoolsRootStorageV1";
...
export class DataLiquidityPoolsRootStorageV1__factory {
  static readonly abi = _abi;
  static createInterface(): DataLiquidityPoolsRootStorageV1Interface {
    return new Interface(_abi) as DataLiquidityPoolsRootStorageV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as DataLiquidityPoolsRootStorageV1;
  }
}
